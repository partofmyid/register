...
This is a short and concise tutorial on how to create a pull request with your desired DNS records on a subdomain. Note that **we have requirements and standards for whatever content you host** on your subdomain. Please refer to the [documentation](/docs/requirements.md).
...
Next, you'll need to **write your DNS record in our JSON schema**. You can find this in the [documentation](/docs/references.md) or alternatively check `scripts/schema.json`. Please make sure your JSON is valid and properly formatted.
